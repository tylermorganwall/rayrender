...
Float triangle::pdf_value(const vec3& o, const vec3& v, random_gen& rng) { 
  hit_record rec;
...
vec3 triangle::random(const vec3& origin, random_gen& rng) {
...
vec3 triangle::random(const vec3& origin, Sampler* sampler) {
