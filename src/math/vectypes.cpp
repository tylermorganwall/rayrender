...
#include "../math/simd.h"
#include "../math/vectypes.h"  // Your provided header with inline functions
...
context("Conversion functions") {
    test_that("[convert_to_point3(vec3f)]") {
        ...
        expect_true(p.xyz.x == Approx(1.0f));
        expect_true(p.xyz.y == Approx(2.0f));
        expect_true(p.xyz.z == Approx(3.0f));
    }
    ...
    test_that("[convert_to_vec3(point3f)]") {
        ...
        expect_true(v.xyz.x == Approx(4.0f));
        expect_true(v.xyz.y == Approx(5.0f));
        expect_true(v.xyz.z == Approx(6.0f));
    }
    ...
    test_that("[convert_to_vec3(normal3f)]") {
        ...
        expect_true(v.xyz.x == Approx(7.0f));
        expect_true(v.xyz.y == Approx(8.0f));
        expect_true(v.xyz.z == Approx(9.0f));
    }
    ...
    test_that("[convert_to_normal3(vec3f)]") {
        ...
        expect_true(n.xyz.x == Approx(10.0f));
        expect_true(n.xyz.y == Approx(-10.0f));
        expect_true(n.xyz.z == Approx(20.0f));
    }
    ...
    test_that("[convert_to_normal3(point3f)]") {
        ...
        expect_true(n.xyz.x == Approx(-4.5f));
        expect_true(n.xyz.y == Approx(0.5f));
        expect_true(n.xyz.z == Approx(2.5f));
    }
}
...
context("Arithmetic operators with point3, vec3, normal3") {
    test_that("[point3 * vec3]") {
        ...
        point3f result = p * v;
        expect_true(result.xyz.x == Approx(2.0f));   // 1*2
        expect_true(result.xyz.y == Approx(-2.0f));  // 2*(-1)
        expect_true(result.xyz.z == Approx(1.5f));   // 3*0.5
    }
    ...
    test_that("[point3 * normal3f]") {
        ...
        point3f result = p * n;
        expect_true(result.xyz.x == Approx(2.0f));   // 4*0.5
        expect_true(result.xyz.y == Approx(-4.0f));  // -2*2
        expect_true(result.xyz.z == Approx(-10.0f)); // 10*(-1)
    }
    ...
    test_that("[normal3f * vec3]") {
        ...
        normal3f result = n * v;
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(4.0f));
        expect_true(result.xyz.z == Approx(-3.0f));
    }
    ...
    test_that("[point3f *= point3f]") {
        ...
        expect_true(result.xyz.x == Approx(6.0f));   // 2*3
        expect_true(result.xyz.y == Approx(-2.0f));  // 2*(-1)
        expect_true(result.xyz.z == Approx(8.0f));   // 2*4
    }
    ...
    test_that("[point3f *= normal3f]") {
        ...
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(-4.0f));
        expect_true(result.xyz.z == Approx(2.5f));
    }
}
...
context("vec3<Float> arithmetic operators") {
    test_that("[vec3 + vec3]") {
        ...
        vec3f result = v1 + v2;
        expect_true(result.xyz.x == Approx(5.0f));
        expect_true(result.xyz.y == Approx(1.0f));
        expect_true(result.xyz.z == Approx(3.0f));
    }
    ...
    test_that("[vec3 - vec3]") {
        ...
        vec3f result = v1 - v2;
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(7.0f));
        expect_true(result.xyz.z == Approx(3.0f));
    }
    ...
    test_that("[vec3 * vec3]") {
        ...
        vec3f result = v1 * v2;
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(6.0f));
        expect_true(result.xyz.z == Approx(-4.0f));
    }
    ...
    test_that("[vec3 / vec3]") {
        ...
        expect_true(result.xyz.x == Approx(5.0f));
        expect_true(result.xyz.y == Approx(4.0f));
        expect_true(result.xyz.z == Approx(2.0f));
    }
    ...
    test_that("[vec3 + Float]") {
        ...
        vec3f result = v + 1.0f;
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(3.0f));
        expect_true(result.xyz.z == Approx(4.0f));
    }
    ...
    test_that("[vec3 - Float]") {
        ...
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(4.0f));
        expect_true(result.xyz.z == Approx(6.0f));
    }
    ...
    test_that("[vec3 * Float]") {
        ...
        vec3f result = v * 3.0f;
        expect_true(result.xyz.x == Approx(3.0f));
        expect_true(result.xyz.y == Approx(-6.0f));
        expect_true(result.xyz.z == Approx(9.0f));
    }
    ...
    test_that("[Float / vec3]") {
        ...
        vec3f result = 8.0f / v;
        expect_true(result.xyz.x == Approx(4.0f));
        expect_true(result.xyz.y == Approx(-4.0f));
        expect_true(result.xyz.z == Approx(2.0f));
    }
...
context("point3<Float> arithmetic operators") {
    test_that("[point3 + point3]") {
        ...
        point3f result = p1 + p2;
        expect_true(result.xyz.x == Approx(0.0f));
        expect_true(result.xyz.y == Approx(2.0f));
        expect_true(result.xyz.z == Approx(8.0f));
    }
    ...
    test_that("[vec3 + point3]") {
        ...
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(3.0f));
        expect_true(result.xyz.z == Approx(5.0f));
    }
    ...
    test_that("[point3 -= vec3]") {
        ...
        p -= v;
        expect_true(p.xyz.x == Approx(3.0f));
        expect_true(p.xyz.y == Approx(2.0f));
        expect_true(p.xyz.z == Approx(1.0f));
    }
    ...
    test_that("[point3 - point3 = vec3]") {
        ...
        vec3f v = p1 - p2;
        expect_true(v.xyz.x == Approx(3.0f));
        expect_true(v.xyz.y == Approx(2.0f));
        expect_true(v.xyz.z == Approx(3.0f));
    }
    ...
    test_that("[point3 - vec3]") {
        ...
        expect_true(result.xyz.x == Approx(2.0f));
        expect_true(result.xyz.y == Approx(-1.0f));
        expect_true(result.xyz.z == Approx(0.5f));
    }
    ...
    test_that("[point3 * point3]") {
        ...
        point3f result = p1 * p2;
        expect_true(result.xyz.x == Approx(6.0f));
        expect_true(result.xyz.y == Approx(2.0f));
        expect_true(result.xyz.z == Approx(4.0f));
    }
    ...
    test_that("[point3 + Float]") {
        ...
        expect_true(result.xyz.x == Approx(3.0f));
        expect_true(result.xyz.y == Approx(2.0f));
        expect_true(result.xyz.z == Approx(1.0f));
    }
    ...
    test_that("[point3 * Float]") {
        ...
        expect_true(result.xyz.x == Approx(-3.0f));
        expect_true(result.xyz.y == Approx(12.0f));
        expect_true(result.xyz.z == Approx(6.0f));
    }
    ...
    test_that("[Lerp between points]") {
        ...
        expect_true(result.xyz.x == Approx(5.0f));
        expect_true(result.xyz.y == Approx(5.0f));
        expect_true(result.xyz.z == Approx(5.0f));
    }
    ...
    test_that("[Min and Max for vec3]") {
        ...
        expect_true(mn.xyz.x == Approx(0.0f));
        expect_true(mn.xyz.y == Approx(4.0f));
        expect_true(mn.xyz.z == Approx(-2.0f));

        expect_true(mx.xyz.x == Approx(1.0f));
        expect_true(mx.xyz.y == Approx(5.0f));
        expect_true(mx.xyz.z == Approx(-1.0f));
    }
    ...
    test_that("[Permute and PermuteInPlace]") {
        ...
        expect_true(perm.xyz.x == Approx(3.0f));
        expect_true(perm.xyz.y == Approx(2.0f));
        expect_true(perm.xyz.z == Approx(1.0f));

        PermuteInPlace(v, 1, 2, 0);
        expect_true(v.xyz.x == Approx(2.0f));
        expect_true(v.xyz.y == Approx(3.0f));
        expect_true(v.xyz.z == Approx(1.0f));
    }
}
