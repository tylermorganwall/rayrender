...
static const R_CallMethodDef CallEntries[] = {
    {"_rayrender_render_scene_rcpp", (DL_FUNC) &_rayrender_render_scene_rcpp, 58},
    {NULL, NULL, 0}
};
