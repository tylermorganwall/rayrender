...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< List >::type mesh_list(mesh_listSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_rayrender_render_scene_rcpp", (DL_FUNC) &_rayrender_render_scene_rcpp, 60},
