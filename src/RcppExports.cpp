...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(render_scene_rcpp(camera_info, ambient_light, type, radius, shape, position_list, properties, velocity, moving, n, bghigh, bglow, ischeckered, checkercolors, gradient_info, noise, isnoise, noisephase, noiseintensity, noisecolorlist, angle, isimage, filelocation, alphalist, lightintensity, isflipped, isvolume, voldensity, parallel, implicit_sample, order_rotation_list, clampval, isgrouped, group_pivot, group_translate, group_angle, group_order_rotation, group_scale, tri_normal_bools, is_tri_color, tri_color_vert, fileinfo, filebasedir, progress_bar, numbercores, debugval, hasbackground, background, scale_list, sigmavec, rotate_env, verbose, debug_channel, shared_id_mat, is_shared_mat));
