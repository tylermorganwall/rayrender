...
void cylinder::get_cylinder_uv(const vec3& p, Float& u, Float& v) {
...
Float cylinder::pdf_value(const vec3& o, const vec3& v, random_gen& rng, Float time) {
  hit_record rec;
...
Float cylinder::pdf_value(const vec3& o, const vec3& v, Sampler* sampler, Float time) {
  hit_record rec;
...
vec3 cylinder::random(const vec3& o, random_gen& rng, Float time) {
...
vec3 cylinder::random(const vec3& o, Sampler* sampler, Float time) {
