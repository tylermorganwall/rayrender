...
The PR 1 render-session layer is intentionally RGB-only. PR 2 through PR 15 spectral code is
...
RandomWalk transport tests, PathIntegrator estimator tests, and Film render-loop tests.
