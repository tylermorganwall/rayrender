...
The PR 1 render-session layer is intentionally RGB-only. PR 2 through PR 10 spectral code is
...
spectral camera generation, spectral scene/shape adaptation, and allocation tests.
