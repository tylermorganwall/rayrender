...
texture layer. PR 8 adds the spectral PixelSensor and Film accumulation layer.
...
The PR 1 render-session layer is intentionally RGB-only. PR 2 through PR 8 spectral code is
