...
wavelength-aware spectral camera interface.
...
The PR 1 render-session layer is intentionally RGB-only. PR 2 through PR 9 spectral code is
...
spectral camera generation, and allocation tests.
