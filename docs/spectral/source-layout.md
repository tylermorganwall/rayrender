...
The PR 1 render-session layer is intentionally RGB-only. PR 2 through PR 19 spectral code is
...
material closure tests, diffuse-transmission material tests, and legacy glossy schema adaptation
tests.
