...
#'   add_object(ellip_scene) |>
#'   add_object(sphere(y=50,radius=10,material=light(intensity=30))) |>
#'   add_object(obj_model(r_obj(simple_r = TRUE),x=10,y=-10,scale_obj=3, angle=c(0,135,0),
#'                        material=dielectric(attenuation=c(1,1,0.3)))) |>
#'   add_object(pig(x=-7,y=10,z=-5,angle=c(0,-45,-80),emotion="angry")) |>
#'   add_object(pig(x=0,y=-0.25,z=-15,angle=c(0,225,22), order_rotation = c(3,2,1),
