...
lambertian = function(x=0, y=0, z=0, radius=1, color = "#ffffff") {
  color = convert_color(color)
  tibble::tibble(x=x,y=y,z=z,radius=radius, type = "lambertian", properties = list(color))
}
...
metal = function(x=0, y=0, z=0, radius=1, color = "#ffffff", fuzz = 0) {
  color = convert_color(color)
  tibble::tibble(x=x,y=y,z=z,radius=radius, type = "metal", properties = list(c(color,fuzz)))
}
...
dielectric = function(x=0, y=0, z=0, radius=1, refraction = 1.5) {
  tibble::tibble(x=x,y=y,z=z,radius=radius, type = "dielectric", properties = list(refraction))
}